...
class TestGameObject(TestCase):
    def test_engage(self):
        ...
        power_gem = GameObject({"ATK_UP": 2})
        guard_piece = GameObject({"DEF_UP": 1})
        guard_gem = GameObject({"DEF_UP": 2})
        life_potion = GameObject({"HP_UP": 2000})
        power_potion = GameObject({"HP_UP": 300, "ATK_UP": 3})
        red_potion = GameObject({"HP_UP": 200})
        blue_potion = GameObject({"HP_UP": 800})
        heavenly_potion = GameObject({"HP_UP": 3000, "ATK_UP": 3, "DEF_UP": 3})
        yellow_lock = GameObject({"REQUIRES_KEYITEM": KeyItem.YELLOW_KEY})
        yellow_key = GameObject({"GIVES_KEYITEM": (KeyItem.YELLOW_KEY, 1)})

        junior_fighter = GameObject({"HP": 120, "ATK": 55, "DEF": 25, "EXP": 2})
        fighter = GameObject({"HP": 320, "ATK": 110, "DEF": 40, "EXP": 5})
        elder_fighter = GameObject({"HP": 600, "ATK": 145, "DEF": 65, "EXP": 10})
        junior_ranger = GameObject({"HP": 200, "ATK": 200, "DEF": 10, "EXP": 4})
        ranger = GameObject({"HP": 200, "ATK": 350, "DEF": 20, "EXP": 16})
